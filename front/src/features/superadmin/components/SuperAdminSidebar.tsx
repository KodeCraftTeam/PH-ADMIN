...
interface Props {
  currentView: SuperAdminViewMode;
...
export function SuperAdminSidebar({
  ...
  const menuItems: {
    ...
    },
    {
      ...
      icon: (p) => (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={p.className || "h-4 w-4"}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12h5.25c.621 0 1.125.504 1.125 1.125v10.5c0 .621-.504 1.125-1.125 1.125H7.5A2.25 2.25 0 015.25 18.75V6A2.25 2.25 0 017.5 3.75h9.75a2.25 2.25 0 012.25 2.25v12.75a2.25 2.25 0 01-2.25 2.25H12" />
        </svg>
      ),
    },
    {
  ...
  return (
    <>
      ...
      {/* Footer Profile & Operating Status (Pinned to Bottom) */}
      <div className="p-4 border-t border-slate-100 dark:border-zinc-800/80 space-y-3 mt-auto bg-white/50 dark:bg-zinc-900/50">
        <div className="rounded-xl border border-slate-200/60 dark:border-zinc-800/60 bg-slate-50/80 dark:bg-zinc-800/30 p-3 backdrop-blur-xs">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-[11px] font-bold text-slate-800 dark:text-zinc-200">Sistema Operativo</p>
              <p className="text-[10px] text-slate-400 dark:text-zinc-500">Node API v1.0 • Latencia 12ms</p>
            </div>
          </div>
        </div>
