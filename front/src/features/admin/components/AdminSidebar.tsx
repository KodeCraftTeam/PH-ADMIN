...
import { IconDollar, IconUsers } from "@/components/ui";
...
export function AdminSidebar({
      ...
      icon: (p) => (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M10.34 15.84c-.688-.06-1.38-.09-2.072-.09-1.944 0-3.8.31-5.52.88a.75.75 0 01-.998-.707V5.625a.75.75 0 01.998-.707c1.72.57 3.576.88 5.52.88 2.08 0 4.07-.35 5.92-.99A.75.75 0 0115 5.518v9.964a.75.75 0 01-.415.67 19.98 19.98 0 00-4.245.688zM19.5 4.5v15m-3-12v9m6-6v3"
          />
        </svg>
      ),
    },
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-14 left-0 bottom-0 z-40 w-64 border-r border-slate-200/80 dark:border-zinc-800/80 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md flex flex-col justify-between overflow-y-auto transition-transform duration-200 ease-in-out md:static md:z-20 md:h-[calc(100vh-3.5rem)] md:translate-x-0 ${
