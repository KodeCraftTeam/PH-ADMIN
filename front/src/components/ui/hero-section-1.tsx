...
import { ArrowRight, BarChart3, Building2, ChevronRight, CreditCard, Menu, MessageSquare, ShieldCheck, Wand2, X } from 'lucide-react'
    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                    ...
                    <div className="relative pt-24 md:pt-36">
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Plataforma SaaS para Copropiedades & Conjuntos</span>
                                    ...
                                    <h1
                                        className="mt-8 max-w-4xl mx-auto text-balance text-5xl font-bold tracking-tight md:text-6xl lg:mt-12 xl:text-7xl">
                                        La Solución Integral para la Gestión de tus Copropiedades
                                    </h1>
                                    <p
                                        className="mx-auto mt-6 max-w-2xl text-balance text-lg text-muted-foreground">
                                        Administra conjuntos residenciales, cartera, comunicados y analítica financiera en tiempo real con una interfaz moderna y veloz.
                                    </p>
                                </AnimatedGroup>
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="/onboarding">
                                                <span className="text-nowrap">Comenzar Onboarding</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-10.5 rounded-xl px-6 border">
                                        <Link href="/superadmin">
                                            <span className="text-nowrap">Ver Panel SuperAdmin</span>
                                        </Link>
                                    </Button>
                                </AnimatedGroup>
                            </div>
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-16">
                                ...
                                />
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-2 shadow-2xl shadow-zinc-950/20 ring-1">
                                    <img
                                        className="bg-background relative block rounded-xl w-full object-cover shadow-lg border border-border/40"
                                        src="/dashboard-preview.png"
                                        alt="KodeCraft PH SuperAdmin Dashboard"
                                        width="1920"
                                        height="945"
                                    />
                                </div>
                ...
                {/* Seccion Tu Mejor Aliado / Proyecto Horizontal */}
                <section className="bg-background py-20 border-t">
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            <span className="text-sm font-semibold tracking-wider text-primary uppercase bg-muted px-3 py-1 rounded-full border">
                                Tu Mejor Aliado en Gestión Inmobiliaria
                            </span>
                            <h2 className="mt-4 text-3xl font-bold tracking-tight md:text-4xl">
                                Todo lo que necesitas para tu Copropiedad en una sola plataforma
                            </h2>
                            <p className="mt-4 text-base text-muted-foreground">
                                Diseñado para ofrecer control administrativo total, transparencia con propietarios y automatización de procesos contables.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Gestión de Cartera & Cobranza</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Control en tiempo real de cuotas de administración, facturación recurrente y estado de mora por inmueble.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Onboarding Guiado en Minutos</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Asistente paso a paso para la creación de copropiedades, torres, unidades y carga masiva de coeficientes.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Comunicados & Canales PQRS</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Emisión de circulares generales y gestión centralizada de peticiones, quejas y reclamos de la comunidad.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Métricas y Analítica MRR</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Gráficos interactivos de rendimiento comercial, distribución por planes y tasa de retención global.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Multi-Copropiedad Escalable</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Administra múltiples conjuntos residenciales, torres y 790+ unidades de forma limpia e independiente.
                                </p>
                            </div>
                            ...
                            <div className="rounded-2xl border bg-card p-6 shadow-sm hover:shadow-md transition-all">
                                ...
                                <h3 className="text-xl font-semibold mb-2">Seguridad y Permisos por Rol</h3>
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Estructura de roles granulares para SuperAdmin, administradores de conjunto, contadores y residentes.
                                </p>
                            </div>
                        </div>

                        {/* Banner Horizontal de Estadisticas */}
                        <div className="mt-16 rounded-2xl border bg-muted/40 p-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                            <div>
                                <p className="text-3xl font-extrabold text-primary">$9.2M+</p>
                                <p className="text-sm text-muted-foreground mt-1 font-medium">MRR Facturado</p>
                            </div>
                            <div>
                                <p className="text-3xl font-extrabold text-primary">792</p>
                                <p className="text-sm text-muted-foreground mt-1 font-medium">Unidades Registradas</p>
                            </div>
                            <div>
                                <p className="text-3xl font-extrabold text-primary">96.8%</p>
                                <p className="text-sm text-muted-foreground mt-1 font-medium">Tasa de Retención</p>
                            </div>
                            <div>
                                <p className="text-3xl font-extrabold text-primary">100%</p>
                                <p className="text-sm text-muted-foreground mt-1 font-medium">Transparencia & Control</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-background pb-16 pt-12">
                    <div className="group relative m-auto max-w-5xl px-6 text-center">
                        <p className="text-sm font-semibold text-muted-foreground tracking-wider uppercase mb-8">
                            Respaldado por tecnología de clase mundial
                        </p>
...
const menuItems = [
    { name: 'SuperAdmin Panel', href: '/superadmin' },
    { name: 'Admin Dashboard', href: '/admin' },
    { name: 'Onboarding Wizard', href: '/onboarding' },
]
